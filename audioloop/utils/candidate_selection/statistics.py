"""
Statistics and reporting for candidate selection.

This module provides functions for printing comprehensive statistics about
the candidate selection process in active learning.
"""
...
def print_selection_statistics(
    ...
    Args:
        ...
        selected_candidates: Subset selected as candidates
        strategy_name: Name of the selection strategy used
        positive_class_name: Name of the positive class
        negative_class_name: Name of the negative class
